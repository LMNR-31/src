...
once with the following three transforms (matching
`tf_body_fallback.launch.py` + `tf_camera_static.launch.py`):
...
`tf2_ros.TransformBroadcaster`.  This is equivalent to running the
